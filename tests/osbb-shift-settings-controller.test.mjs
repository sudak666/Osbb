...
function fixture() {
  const elements = Object.fromEntries(['shift-legend-sergiy','shift-stat-name-sergiy','shift-editor-name-sergiy','shift-legend-oleksandr','shift-stat-name-oleksandr','shift-editor-name-oleksandr','shift-name-third','shift-heading','shift-name-sergiy','shift-name-oleksandr'].map(id => [id, { textContent: '', value: '', focus() {} }]));
