-- Supabase CLI migration mirror for sklad/supabase/020_allow_board_manage_staff_access.sql.
-- Keep this file synchronized with the historical SQL file while the project migrates to CLI migrations.

-- Повторно застосовує права Правління для баз, де міграцію 019 вже виконано.
