export function dateInputToTimestamp(dateValue: unknown, now: Date = new Date()): string | null {
...
export function dateToInputValue(value: unknown, fallback: Date = new Date()): string {
