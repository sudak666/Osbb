...
Так, проєкт технічно можливо перевести на сучасний production-стек, але це не точковий рефакторинг поточних HTML-файлів, а фактично окремий етап перепису. Поточна архітектура навмисно проста: статичні сторінки без збірки, спільний PIN і ручне виконання SQL-файлів. Для масштабу одного будинку це зменшує вартість підтримки, але має зрозумілі межі.
