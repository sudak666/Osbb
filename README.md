...
5. Склад: `sklad/supabase/add_internal_use_flag.sql` — додає поле `is_internal` (внутрішнє використання/хознужди) до `inventory_items`. Без цього скрипту кнопка "Додати товар" видаватиме помилку, оскільки фронтенд надсилає це поле в кожному запиті створення товару.
...
- можуть бути приховані пілкою "Без внутрішніх" на сторінці "Товари";
