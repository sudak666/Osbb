...
Правління або адміністратор можуть відкрити «Доступ користувачів» у шапці журналу та ввімкнути або вимкнути персональний PIN-вхід для інших користувачів. Для цього має бути застосована міграція `019_staff_login_settings.sql`; поточний користувач не може вимкнути власний активний обліковий запис.
